      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            {/* Variation Selector */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-primary">{t('choose_fit')}</h3>
            ...
            {/* Product Features */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-primary">{t('features_title')}</h3>
            ...
            {/* Materials */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-primary">{t('materials_care')}</h3>
              <div className="bg-background rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-primary mb-2">{t('materials')}</h4>
                  ...
                  <div>
                    <h4 className="font-medium text-primary mb-2">{t('care_instructions')}</h4>
                    <ul className="space-y-1">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-primary">{t('quantity')}</h3>
              ...
              <div className="grid grid-cols-3 gap-4 pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-text-secondary font-medium">{t('secure_payment')}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-xs text-text-secondary font-medium">{t('fast_shipping')}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-xs text-text-secondary font-medium">{t('quality_guarantee')}</p>
                </div>
              </div>
            </div>
          </div>
