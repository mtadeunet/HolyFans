            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className={`transition-all duration-500 overflow-hidden ${expandedObjection === objection.id ? 'max-h-96' : 'max-h-0'
                    }`}>
                ...
                <div className={`transform transition-transform duration-300 ${expandedObjection === objection.id ? 'rotate-180' : ''
                  }`}>
