            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all duration-500 text-left w-full ${selectedFeature === 0
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all duration-500 text-left w-full mt-4 ${selectedFeature === 1
                      ? 'border-accent bg-accent/5 shadow-lg'
                      : 'border-transparent hover:border-accent/30 bg-background'
                    }`}
                >
              ...
              <div>
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all duration-500 text-left w-full ${selectedFeature === 2
                      ? 'border-accent bg-accent/5 shadow-lg'
                      : 'border-transparent hover:border-accent/30 bg-background'
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all duration-500 text-left w-full mt-4 ${selectedFeature === 3
                      ? 'border-accent bg-accent/5 shadow-lg'
                      : 'border-transparent hover:border-accent/30 bg-background'
                    }`}
                >
